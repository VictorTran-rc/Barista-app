...
var clearOrder = document.querySelector('#clear');
...
enterButton.addEventListener('click', function() {
  ...
  if (currentOrder.name !== "" && currentOrder.drink !== "") {
    ...
    alert("You need to pick a name and drink for your order")
  }
})
